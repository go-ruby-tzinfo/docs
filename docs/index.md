# go-ruby-tzinfo documentation

**Pure-Go (CGO=0) MRI-faithful Ruby TZInfo timezone library**

`go-ruby-tzinfo/tzinfo` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `tzinfo`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `tzinfo`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`tzinfo`](https://github.com/go-ruby-tzinfo/tzinfo) | the library — Ruby's `tzinfo` in pure Go |
| [`docs`](https://github.com/go-ruby-tzinfo/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-tzinfo.github.io`](https://github.com/go-ruby-tzinfo/go-ruby-tzinfo.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-tzinfo/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-tzinfo/tzinfo](https://github.com/go-ruby-tzinfo/tzinfo).

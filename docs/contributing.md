...
Contributions are welcome. `go-ruby-tzinfo/tzinfo` is built to a small set of
...
The library is in [`github.com/go-ruby-tzinfo/tzinfo`](https://github.com/go-ruby-tzinfo/tzinfo).
This documentation site is in [`github.com/go-ruby-tzinfo/docs`](https://github.com/go-ruby-tzinfo/docs).

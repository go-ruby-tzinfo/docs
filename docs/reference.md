...
The public API lives at the module root (`github.com/go-ruby-tzinfo/tzinfo`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `tzinfo`, while the surface follows
...
```go
import "github.com/go-ruby-tzinfo/tzinfo"
```
...
- **[pkg.go.dev/github.com/go-ruby-tzinfo/tzinfo](https://pkg.go.dev/github.com/go-ruby-tzinfo/tzinfo)**

The module's [README](https://github.com/go-ruby-tzinfo/tzinfo#readme) carries worked
